...
def re_write_query(query):
    ...
    database of text books and pdfs if the quetions are not needed just give the same quetion. By generating multiple perspectives on the user question, your goal is to help
